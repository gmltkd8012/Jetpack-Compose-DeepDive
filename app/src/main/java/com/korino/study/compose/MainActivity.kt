...
// import com.skydoves.compose.stability.runtime.TraceRecomposition  // stability-analyzer 비활성화
...
class MainActivity : ComponentActivity() {
    ...
    // @TraceRecomposition  // stability-analyzer 비활성화
    @Composable
    fun TransitionBox(
